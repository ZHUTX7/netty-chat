...
public class MsmConstantUtils implements InitializingBean {
    ...
    public static String OTEMPLATE_ID;
     ...
     * @return
     */
    public static boolean sendPhone(String regionCode,String countryCode,String phone  , String sixBitRandom) {
        //判断手机号是否为空
        ...
        try{
            ...
            if(countryCode.equals("CN")){
                ...
                req.setTemplateID(MsmConstantUtils.OTEMPLATE_ID);//模板 ID: 必须填写已审核通过的模板 ID
            }
            //发送的验证码
            String[] templateParamSet1 = {sixBitRandom,"2"};//模板的参数 第一个是验证码，第二个是过期时间
