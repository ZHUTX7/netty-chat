...
public class RedisStringUtil {
    ...
    public void delByPrefixKeyName(String prefix){
    ...
    public void batchInsert(Map<String, Object> saveMap) {
        /* 插入多条数据 */
    ...
    public void batchDelByKey(List<String> delKeyList,String key) {
        /* 删除多条数据 */
        redisTemplate.executePipelined(new SessionCallback<Object>() {
            @Override
            public <K, V> Object execute(RedisOperations<K, V> redisOperations) throws DataAccessException {
                for (String e:delKeyList) {
                    redisTemplate.delete(key+e);
                }
                return null;
            }
        });
    ...
    public List<String> lget(String key,int start ,int size){
